...
//    
    ...
    public String lodeEditCustomer(@PathVariable(value = "customerid") int customerid, Model m) {
        Customer cus = customerService.getById(customerid);

        System.out.println(cus);
        m.addAttribute("updateCustomer", cus);
        m.addAttribute("title", "Edit Cus");

        return "editCustomer";
    }
    
    @PostMapping("/editCustomer/updateCustomer")
    public String updateCustomer(@ModelAttribute("updateCustomer") Customer cus) {
        customerService.updateCustomer(cus);

        return "redirect:/adminPassenger";
    }
